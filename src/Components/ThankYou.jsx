...
const ThankYou = () => {
  return (
    <div className="flex items-center justify-center min-h-[50vh]: sm:min-h-[70vh] px-4 bg-none">
      <div className="flex flex-col justify-center items-center text-center">
        ...
        />
        <h1 className="text-3xl sm:text-5xl 2xl:text-6xl 3xl:text-7xl font-bold mb-3">
          Thank You
        </h1>
